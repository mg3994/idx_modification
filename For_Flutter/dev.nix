  ...
  idx = {
    ...
    # Runs when the workspace is (re)started
      onStart = {
        ...
        #  run-flutter-web = "cd ${flutterProjectDir} && flutter run --machine -d web-server --web-hostname 0.0.0.0 --web-port $PORT --enable-experiment=macros";
    ...
    previews = {
      ...
      previews = {
        ...
        web = {
          ...
          command = ["flutter" "run" "--machine" "-d" "web-server" "--web-hostname" "0.0.0.0" "--web-port" "$PORT" "--target=${flutterProjectDir}/lib/main.dart"  ];
          manager = "flutter";
        };
        android = {
